...
if __name__ == "__main__":
	create_lexicon('./grs/lexicons/original_amr_lexicons/pred_for_120_anno1.txt',
					'./grs/lexicons/subcat/pred_for_120_part1.lp',
					'./grs/lexicons/original_amr_lexicons/pred_for_120_anno1.txt')
	sort_file('./grs/lexicons/subcat/pred_for_120_part1.lp')
